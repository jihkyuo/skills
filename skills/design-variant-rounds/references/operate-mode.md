<!-- 출처: pbakaus/impeccable@5a7e283 plugin/skills/impeccable/reference/operate.md · Apache-2.0 · verbatim. 제품 UI(Operate 모드) 전용 오버라이드. frontend-design 의 «히어로=논제·서체 짝·미적 위험» 지시와 충돌하면 이 파일이 이긴다. -->
